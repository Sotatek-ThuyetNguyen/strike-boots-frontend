...
export interface SotatekTokenInterface extends utils.Interface {
  functions: {
    ...
    "mintForUser(uint256)": FunctionFragment;
...
export interface SotatekToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SotatekTokenInterface;
  ...
  callStatic: {
    ...
    mintForUser(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
