...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "address",
        name: "_treasureContract",
        type: "address",
      },
    ],
    name: "setTreasureContract",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [
      ...
      {
        internalType: "enum IUniswapV2Router01.LiquidityFeeOptions",
        name: "lpOption",
        type: "uint8",
      },
      {
